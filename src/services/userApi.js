...
const getCounselorProfile = (id) => {
    return userAxiosInstance.get(`/user/get-counselor-profile/${id}`, { withCredentials: true })
}


const getCounselorEducation = (id) => {
    return userAxiosInstance.get(`/user/get-counselor-education/${id}/`, { withCredentials: true })
}
