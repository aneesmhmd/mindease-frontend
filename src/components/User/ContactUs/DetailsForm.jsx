...
function DetailsForm() {
  ...
  const onSubmit = async (values, {resetForm}) => {
    await addCallBackReqs(values).then((res)=>{
  ...
  return (
    <div className='flex flex-col items-center text-center w-full h-full bg-teal-100 pt-4 gap-3'>
      ...
      <Typography
        className='text-sm font-thin md:mx-0 mx-0.5'
      >
        Please fill the form given below.<br />
      ...
      <form className='w-3/4 mt-3' onSubmit={formik.handleSubmit}>
        <div className='flex flex-col items-center gap-4 max-h-72'>
          ...
          <Button type='submit' color='teal' className='w-3/4 mb-6'>
            Submit
          </Button>
        </div>
      </form>
